...
based mllib_tests" section become subclasses of the classes in the "Generic
mllib_tests" section. This is done by the functions in the "Tailored base
class for generic mllib_tests" section.
...
Run mllib_tests if scipy is installed:
  python -c 'import scipy;scipy.sparse.test()'
Run mllib_tests if sparse is not installed:
  python mllib_tests/test_base.py
"""
...
class _TestCommon:
    ...
    def test_ufunc_object_array(self):
        # This mllib_tests compatibility with previous Numpy object array
...
class _TestSolve:
    def test_solve(self):
        ...
        n = 20
        np.random.seed(0)  # make mllib_tests repeatable
...
class _TestFancyIndexing:
    """Tests fancy indexing features.  The mllib_tests for any matrix formats
...
#------------------------------------------------------------------------------
# Tailored base class for generic mllib_tests
#------------------------------------------------------------------------------

def _possibly_unimplemented(cls, require=True):
    """
    Construct a class that either runs mllib_tests as usual (require=True),
...
def sparse_test_class(getset=True, slicing=True, slicing_assign=True,
    ...
    """
    Construct a base class, optionally converting some of the mllib_tests in
...
#------------------------------------------------------------------------------
# Matrix class based mllib_tests
#------------------------------------------------------------------------------
...
class TestDOK(sparse_test_class(minmax=False, nnz_axis=False)):
    ...
    def test_resize(self):
        # A couple basic mllib_tests of the resize() method.
        #
...
class Test64Bit(object):
    ...
    # The following features are missing, so skip the mllib_tests:
    SKIP_TESTS = {
