...
class BasinHoppingRunner(object):
    ...
    accept_tests : list of callables
        ...
        `x_old`.  These mllib_tests will be used to judge whether or not to accept
        the step.  The acceptable return values are True, False, or ``"force
        accept"``.  If any of the mllib_tests return False then the step is rejected.
        If the latter, then this will override any other mllib_tests in order to
...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,
    ...
    accept_test : callable, ``accept_test(f_new=f_new, x_new=x_new, f_old=fold, x_old=x_old)``, optional
        ...
        False, or ``"force accept"``. If any of the mllib_tests return False
        then the step is rejected. If the latter, then this will override any
        other mllib_tests in order to accept the step. This can be used, for example,
