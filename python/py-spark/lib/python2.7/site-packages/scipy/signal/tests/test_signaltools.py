...
class TestConvolve(_TestConvolve):
    ...
    def test_convolve_method(self, n=100):
        ...
        for t1, t2, mode in args:
            ...
            # threshold to have mllib_tests pass.
    ...
    def test_convolve_method_large_input(self):
        ...
        for n in [10, 20, 50, 51, 52, 53, 54, 60, 62]:
            ...
            # issue #6076 has more detail, hopefully more mllib_tests after resolved
            if n < 50:
...
class TestHilbert(object):
    ...
    def test_hilbert_axisN(self):
        # mllib_tests for axis and N arguments
...
class TestSOSFilt(TestCase):
    ...
    # The test_rank* mllib_tests are pulled from _TestLinearFilter
    def test_rank1(self):
