...
Need function load / save / roundtrip mllib_tests
...
# generator for load mllib_tests
def test_load():
...
# generator for whos mllib_tests
def test_whos():
    for case in case_table4 + case_table5:
        name = case['name']
        expected = case['expected']
...
# generator for round trip mllib_tests
def test_round_trip():
...
def test_read_opts():
    # mllib_tests if read is seeing option sets, at initialization and after
    # initialization
