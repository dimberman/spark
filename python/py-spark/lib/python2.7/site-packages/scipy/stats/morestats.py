...
def shapiro(x, a=None, reta=False):
    ...
    The Shapiro-Wilk test mllib_tests the null hypothesis that the
    ...
    .. [3] Razali, N. M. & Wah, Y. B. (2011) Power comparisons of Shapiro-Wilk,
           Kolmogorov-Smirnov, Lilliefors and Anderson-Darling mllib_tests, Journal of
...
def anderson_ksamp(samples, midrank=True):
    ...
    one-sample Anderson-Darling test. It mllib_tests the null hypothesis
...
def bartlett(*args):
    ...
    Bartlett's test mllib_tests the null hypothesis that all input samples
    ...
    nonparametric mllib_tests by extensive simulations and they conclude that the
    mllib_tests proposed by Fligner and Killeen (1976) and Levene (1960) appear to be
...
def levene(*args, **kwds):
    ...
    The Levene test mllib_tests the null hypothesis that all input samples
...
def fligner(*args, **kwds):
    ...
    Fligner's test mllib_tests the null hypothesis that all input samples
    ...
    .. [2] Fligner, M.A. and Killeen, T.J. (1976). Distribution-free two-sample
           mllib_tests for scale. 'Journal of the American Statistical Association.'
           71(353), 210-213.
    ...
    .. [4] Conover, W. J., Johnson, M. E. and Johnson M. M. (1981). A
           comparative study of mllib_tests for homogeneity of variances, with
...
def wilcoxon(x, y=None, zero_method="wilcox", correction=False):
    ...
    The Wilcoxon signed-rank test mllib_tests the null hypothesis that two
    related paired samples come from the same distribution. In particular,
    it mllib_tests whether the distribution of the differences x - y is symmetric
