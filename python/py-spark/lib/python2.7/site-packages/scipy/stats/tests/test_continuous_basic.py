...
These mllib_tests currently check only/mostly for serious errors and exceptions,
...
DECIMAL = 5  # specify the precision of the mllib_tests  # increased from 0 to 5
...
def test_rvs_gh2069_regression():
    # Regression mllib_tests for gh-2069.  In scipy 0.17 and earlier,
    # these mllib_tests would fail.
    #
...
def check_distribution_rvs(dist, args, alpha, rvs):
    # test from scipy.stats.mllib_tests
