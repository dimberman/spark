...
#
# The mllib_tests are more of interface than they are of the underlying blas.
# Only very small matrices checked -- N=3 or so.
#
# !! Complex calculations really aren't checked that carefully.
# !! Only real valued complex numbers are used in mllib_tests.
...
class BaseAxpy(object):
    ''' Mixin class for axpy mllib_tests '''
...
class BaseSwap(object):
    ''' Mixin class for swap mllib_tests '''
...
class BaseGemv(object):
    ''' Mixin class for gemv mllib_tests '''
