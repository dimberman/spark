...
Run mllib_tests if linalg is not installed:
  python mllib_tests/test_decomp.py
"""
...
def test_eigh_of_sparse():
    # This mllib_tests the rejection of inputs that eigh cannot currently handle.
    import scipy.sparse
...
class TestLU(TestCase):
    ...
    # rectangular matrices mllib_tests
...
def test_orth_memory_efficiency():
    ...
    # Keep in mind that @dec.slow mllib_tests are likely to be running
    # under configurations that support 4Gb+ memory for mllib_tests related to
    # 32 bit overflow.
    n = 10*1000*1000
    try:
        _check_orth(n)
