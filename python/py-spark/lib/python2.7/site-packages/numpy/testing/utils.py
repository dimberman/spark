...
def import_nose():
    ...
    if not nose_is_good:
        msg = ('Need nose >= %d.%d.%d for mllib_tests - see '
...
def assert_array_less(x, y, err_msg='', verbose=True):
    ...
    See Also
    --------
    assert_array_equal: mllib_tests objects for equality
...
def rundocs(filename=None, raise_on_error=True):
    ...
    argument to the ``test()`` call. For example, to run all mllib_tests (including
...
def _assert_valid_refcount(op):
    ...
    Used in a few regression mllib_tests.
    """
    if not HAS_REFCOUNT:
        return True
    import numpy as np
...
class suppress_warnings(object):
    ...
    mllib_tests might need to see the warning. Additionally it allows easier
