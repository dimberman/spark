...
class NumpyDocTestFinder(doctest.DocTestFinder):
    ...
    def _find(self, tests, obj, name, module, source_lines, globs, seen):
        """
        Find mllib_tests for the given object and any contained objects, and
        add them to `mllib_tests`.
        """
        ...
        # Look for mllib_tests in a module's contained objects.
        ...
        # Look for mllib_tests in a class's contained objects.
...
class NumpyOutputChecker(doctest.OutputChecker):
    def check_output(self, want, got, optionflags):
        ...
        if not ret:
            ...
            # bigendian machines don't fail all the mllib_tests (and there are
...
class NumpyDoctest(npd.Doctest):
    ...
    def set_test_context(self, test):
        ...
        """
        # set the namespace for mllib_tests
        ...
        test.globs = {'__builtins__':__builtins__,
                      ...
                      '__name__':'__main__',
                      'np':numpy}
        # add appropriate scipy import for SciPy mllib_tests
    ...
    # Ignore NumPy-specific build files that shouldn't be searched for mllib_tests
...
# Class allows us to save the results of the mllib_tests in runTests - see runTests
