...
class TestMinMax(TestCase):
    def test_minmax_blocked(self):
        # simd mllib_tests on max/min, test all alignments, slow but important
...
class TestAbsoluteNegative(TestCase):
    def test_abs_neg_blocked(self):
        # simd mllib_tests on abs, test all alignments for vz + 2 * (vs - 1) + 1
...
class TestSpecialMethods(TestCase):
    ...
    def test_ufunc_override_with_super(self):
        ...
        # some mllib_tests with a non-ndarray subclass
        a = np.arange(5.)
        b = B()
        ...
        # regression check for gh-9102 -- mllib_tests ufunc.reduce implicitly.
        ...
        assert_(c is b)
        assert_(c.info, {'inputs': [0], 'outputs': [0]})
        # simple explicit mllib_tests of reduce, accumulate, reduceat
...
class TestComplexFunctions(object):
    ...
    def check_loss_of_precision(self, dtype):
        ...
        if dtype is np.longcomplex:
            ...
            # So, give more leeway for long complex mllib_tests here:
