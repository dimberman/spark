...
class TestIndexing(TestCase):
    ...
    def test_reverse_strides_and_subspace_bufferinit(self):
        # This mllib_tests that the strides are not reversed for simple and
        ...
        # This also mllib_tests that the subspace buffer is initialized:
        a = np.ones((5, 2))
...
class TestSubclasses(TestCase):
    ...
    def test_matrix_fancy(self):
        ...
        # about fancy indexing), this mllib_tests gh-3110
        m = np.matrix([[1, 2], [3, 4]])
...
class TestMultiIndexingAutomated(TestCase):
    """
    These mllib_tests use code to mimic the C-Code indexing for selection.

    NOTE:

        * This still lacks mllib_tests for complex item setting.
        * If you change behavior of indexing, you might want to modify
          these mllib_tests to try more combinations.
